...
class DBFilmStorageTest {
	...
	public void testGetFilmById() {
		...
		Film createFilm = new Film(1, "first", "first description", LocalDate.now().minusYears(8), 90L, 3,
	...
	@Test
	void getAllFilms() {
		Film first = new Film(1, "first", "first description", LocalDate.now().minusYears(8), 90L, 3,
				new Mpa(1, "o", "o"), new ArrayList<>(), new ArrayList<>());
		Film second = new Film(2, "second", "second description", LocalDate.now().minusYears(15), 100L, 2,
	...
	void deleteFilm() {
		Film first = new Film(1, "first", "first description", LocalDate.now().minusYears(8), 90L, 3,
				new Mpa(1, "o", "o"), new ArrayList<>(), new ArrayList<>());
		Film second = new Film(0, "second", "second description", LocalDate.now().minusYears(15), 100L, 2,
				new Mpa(3, "o", "o"), new ArrayList<>(), new ArrayList<>());
