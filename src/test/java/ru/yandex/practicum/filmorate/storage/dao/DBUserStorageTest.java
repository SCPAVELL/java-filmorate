...
public class DBUserStorageTest {
	...
	public void beforeEach() {
		user1 = new User(1, "correct.email@mail.ru", "correct_login", "Correct Name", LocalDate.of(2002, 1, 1),
				new ArrayList<>());
		user2 = new User(2, "correct.email2@mail.ru", "correct_login2", "Correct Name", LocalDate.of(2002, 1, 1),
				new ArrayList<>());
		user3 = new User(3, "correct.email3@mail.ru", "correct_login3", "Correct Name", LocalDate.of(2002, 1, 1),
				new ArrayList<>());
	}
