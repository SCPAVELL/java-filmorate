...
public class ErrorHandler {
	...
	@ExceptionHandler({ FilmNotFoundException.class, FilmHasAlreadyCreatedException.class, NotLikeException.class,
			LikeHasAlreadyCreatedException.class, DirectorNotFoundException.class,
			DirectorHasAlreadyCreatedException.class })
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public Map<String, String> handleFilmExceptions(final RuntimeException e) {
		return Map.of("error", "Ошибка действия с фильмом", "errorMessage", e.getMessage());
	}

	@ExceptionHandler(ReviewNotFoundException.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public Map<String, String> handleReviewNotFoundExceptions(final ReviewNotFoundException exc) {
		return Map.of("error", "Ошибка действия с ревью", "errorMessage", exc.getMessage());
	}
	...
	public Map<String, String> handleUserExceptions(final RuntimeException e) {
		return Map.of("error", "Ошибка действия с пользователем", "errorMessage", e.getMessage());
	}
	...
	public Map<String, String> handleRatingExceptions(final RuntimeException e) {
		return Map.of("error", "Ошибка действия с рейтингом", "errorMessage", e.getMessage());
	}
	...
	public Map<String, String> handleGenreExceptions(final RuntimeException e) {
		return Map.of("error", "Ошибка действия с жанром", "errorMessage", e.getMessage());
	}
