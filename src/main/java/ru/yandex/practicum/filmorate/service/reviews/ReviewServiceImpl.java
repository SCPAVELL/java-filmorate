...
public class ReviewServiceImpl implements ReviewService {
	...
	public Review addReview(Review review) {
		...
		feedService.addEvent(reviewFromDb.getUserId(), reviewFromDb.getReviewId(), FeedEventType.REVIEW,
				FeedOperationType.ADD);
		return reviewFromDb;
	}
	...
	public void deleteReview(int reviewId) {
		...
		review.ifPresent(rev -> feedService.addEvent(rev.getUserId(), rev.getReviewId(), FeedEventType.REVIEW,
				FeedOperationType.REMOVE));
